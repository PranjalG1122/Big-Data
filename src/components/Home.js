  ...
  return (
    <main className="home">
      ...
      <div className="home-intro-container">
        <div className="home-intro-text">{dataHome}</div>
        <div
          style={mobileClick ? { right: "-200px" } : { right: "0px" }}
          className="home-intro-sidebar"
        >
          <h1>Categories</h1>
        </div>
      </div>
      ...
      <div
        style={mobileClick ? { right: "5px" } : { right: "150px" }}
        className="about-mobile-icon"
      >
        <button className="about-mobile-button" onClick={mobileClicked}>
          <i
            class={
              mobileClick ? "fa-solid fa-left-long" : "fa-solid fa-right-long"
            }
          ></i>
        </button>
      </div>
